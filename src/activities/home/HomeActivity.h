...
class HomeActivity final : public Activity {
  ...
  static int menuItemToIndex(HomeMenuItem item, bool hasOpdsUrl, bool hasReadwise) {
    int i = 0;
  ...
  static HomeMenuItem indexToMenuItem(int idx, bool hasOpdsUrl, bool hasReadwise) {
    int i = 0;
